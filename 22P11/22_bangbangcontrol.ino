...
#define _SERVO_ANGLE_DIFF  250  // Replace with |D - E| degree
#define _SERVO_SPEED       210  // servo speed

#define _BANGBANG_RANGE    580  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 700 + -2.33*a_value + 1.94E-03*a_value*a_value;
}
